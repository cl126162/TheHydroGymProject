...
def main():  # noqa: F821
    ...
    with warnings.catch_warnings():
        ...
        # Create agent
        model, exploration_policy = make_td3_agent(cfg, train_env, train_env, device)
        ...
        (
            optimizer_actor,
            optimizer_critic,
        ) = make_td3_optimizer(cfg, loss_module)
        ...
        print('Starting training process with rpb size:', len(replay_buffer))
        # Main loop
