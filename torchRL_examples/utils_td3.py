...
def env_maker(cfg, device="cpu"):
    ...
    if lib in ("gym", "gymnasium"):
        ...
        from hydrogym_env_wrapper import make_hydrogym_env
        print('making hydrogym env')
        env = make_hydrogym_env(cfg.hydrogym)
        return env
    elif lib == "dm_control":
...
def make_loss_module(cfg, model):
    ...
    loss_module = TD3Loss(
        ...
        num_qvalue_nets=cfg.optim.num_qvalue_nets,
        loss_function=cfg.optim.loss_function,
        delay_actor=True,
        delay_qvalue=True,
        action_spec=model[0][1].spec,
        policy_noise=cfg.optim.target_policy_noise,
...
def make_td3_optimizer(cfg, loss_module):
